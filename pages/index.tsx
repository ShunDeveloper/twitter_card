...
const Home: NextPage = () => {
  ...
  return (
    <div className="bg-slate-200 px-[15%]">
      <Head>
      ...
      <main className="bg-slate-50 px-[10%] py-[5%]">
        <h1 className="text-5xl font-sans">How to use Twitter Card</h1>
        ...
        <p>
          ...
          summaryが1:1の大きさのカード,
          summary_large_imageが2:1の大きさのカード,
        ...
        <p>
          今回は,{" "}
          <Link href="https://shun-developer.com/blog">自分のブログ</Link>
          に載せる予定の画像を用意しました.
          <br />
          <br />
          <Image
        ...
        <p>
          ...
          スマートフォンとWebで挙動が大きく異なります.
          AndroidとiOSでは表示されず, Webでは1行です.
        </p>
        <Quote
          text="iOS, Android: Not displayed Web: Truncated to three lines in timeline and expanded Tweet"
          sourceName="Twitter"
          source="https://developer.twitter.com/en/docs/twitter-for-websites/cards/overview/summary-card-with-large-image"
        />
        ...
        <p>
          ...
          誤字脱字, 間違い等ありましたら@ShunDeveloper (Twitter)までご連絡下さい
        </p>
      </main>
    </div>
  );
...
const Quote = (quote_props: quote) => {
  return (
    <div className="quote">
      ...
      <p className="text-right underline text-slate-500">
